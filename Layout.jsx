            ...
            <header className="sticky top-0 z-50 bg-[#181818]/80 backdrop-blur-lg border-b border-white/10">
                <div className="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
                    ...
                    <nav className="hidden md:flex items-center gap-8">
                        {[{ title: "Features", url: createPageUrl("Dashboard")}, { title: "Pricing", url: createPageUrl("CampaignBuilder")}, { title: "Explainer", url: createPageUrl("AgentChat")}, { title: "Compare", url: createPageUrl("CreativePlayground")}].map(item => (
                            <Link 
                                key={item.title} 
                                to={item.url} 
                    ...
                    <div className="hidden md:flex items-center gap-4">
                        {user ? (
                            <>
                                <span className="text-sm text-gray-400">guest@example.com</span>
